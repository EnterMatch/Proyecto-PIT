	...
	<div class="modal fade" id="<s:property value="idIncidencia"/>" tabindex="-1" role="article" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<h3 align="center">Resolver Incidente</h3>
            ...
            <h4 class="box-title">Datos del incidente</h4>
            	<div class="col-md-2">
				<label>Id</label>
				<s:hidden name="idIncidencia"><s:property value="idIncidencia"/></s:hidden>
				<input name="idIncidencia" value="<s:text name=""><s:property value="idIncidencia"/></s:text>" disabled="disabled" readonly class="form-control">
				</div>
				<div class="col-md-3">
					<label>Empresa</label>
					<input value="<s:property value="raz_soc_empresa"/>" disabled="disabled" readonly class="form-control">
				</div>
				<div class="col-md-3">	
	            	<label>Cliente</label>
	            	<input value="<s:property value="nombreCliente"/>" disabled="disabled" readonly class="form-control">
				</div>
				<div class="col-md-4">
    	        	<label>Resumen</label>
            ...
            <h4 class="box-title">Datos del mantenimiento</h4>
                <div class="col-md-12">
        			...
        			<textarea class="form-control" name="resumenIncidencia" placeholder="Nueva descripción" style="width: 100%; height: 50px; font-size: 14px; "> 
					</textarea>
				</div>
            	<div class="col-md-12">
        			<label>Nueva Descripción</label>
        			<textarea class="form-control" name="descripIncidencia" placeholder="Nueva descripción" style="width: 100%; height: 50px; font-size: 14px; "> 
					</textarea>
				</div>
				<div class="col-md-12">
              		<label>Solución</label>
              		<textarea class="form-control" name="solucionIncidencia" placeholder="Solución" style="width: 100%; height: 150px; font-size: 14px; ">
              		</textarea>
