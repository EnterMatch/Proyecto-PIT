				...
				<section class="content">
							...
							<div class="box-body">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<s:select cssClass="form-control select2" name="idCliente"
											headerValue="Seleccione Cliente" listKey="idCliente"
											listValue="nombreCliente" list="%{clientes}" />
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col-md-8">
									<div class="box-body pad">
										<s:textarea cssClass="textarea"
											...
											placeholder="Descipcion del incidente"
											name="descripIncidencia"></s:textarea>
									</div>
									<div class="box-body pad">
										<s:textarea cssClass="textarea"
					...
					<div class="col-md-4">
						<div class="box box-primary">
							...
							<br>
							<div class="box-header">
								<h3 class="box-title">¿Grabar Incidente y Asignarlo al
									Grupo?</h3>
							</div>
							<div class="box-body">
								<div class="form-group">
